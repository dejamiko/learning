...
def get_contours_for_object():
    ...
    e._extract_cascade_mask_rcnn(
        image, c.MASK_RCNN_THRESHOLD, "cascade_mask_rcnn_banana"
    )
    ...
    e._extract_cascade_mask_rcnn(
        image, c.MASK_RCNN_THRESHOLD, "cascade_mask_rcnn_hammer"
    )
    ...
    e._extract_cascade_mask_rcnn(
        image, c.MASK_RCNN_THRESHOLD, "cascade_mask_rcnn_scissors"
    )
