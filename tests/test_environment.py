...
def test_get_visual_similarity_works(env_fixture):
    ...
    assert np.allclose(env.get_visual_similarity(0, 2), 0.6297178434321439)
    assert np.allclose(env.get_visual_similarity(0, 4), 0.7615928478640059)
...
def test_get_reachable_object_indices_works(env_fixture):
    ...
    selected = [0, 1, 3]
    expected = {
        0: {(0, np.float64(0.9999999999821028))},
        1: {(1, np.float64(0.9999999999722714))},
        3: {(3, np.float64(0.9999999999759838))},
        4: {(0, np.float64(0.7615928478640062))},
        5: {(1, np.float64(0.8445678675132188))},
        ...
        17: {(3, np.float64(0.7582065102761493))},
        18: {(3, np.float64(0.930504283849278))},
        19: {(0, np.float64(0.6982230245771024))},
        20: {(1, np.float64(0.7420473032534884))},
        26: {(1, np.float64(0.7754640015431563))},
        27: {(3, np.float64(0.7952812150506772))},
        29: {(0, np.float64(0.7605709163786001))},
        30: {(3, np.float64(0.9323678631157304))},
        33: {(1, np.float64(0.720323027775449))},
        35: {(3, np.float64(0.783492427324147))},
        40: {(0, np.float64(0.6965443581843246))},
        41: {(3, np.float64(0.7718289604588451))},
        42: {(0, np.float64(0.746031556833659))},
        45: {(1, np.float64(0.7129841615927401))},
        49: {(0, np.float64(0.7530483265755429))},
        51: {(3, np.float64(0.7074790395538023))},
        54: {(0, np.float64(0.7011657323944228))},
        55: {(1, np.float64(0.7429309108523))},
        59: {(3, np.float64(0.7392262207102812))},
        63: {(0, np.float64(0.7244502355959827))},
        64: {(1, np.float64(0.692062874016476))},
        ...
        78: {(1, np.float64(0.8312504316766414))},
        79: {(0, np.float64(0.7401230114630276))},
        84: {(0, np.float64(0.7623941708484167))},
        86: {(0, np.float64(0.8673067209720567))},
        87: {(3, np.float64(0.765004164767046))},
        89: {(0, np.float64(0.8569205530130775))},
        90: {(1, np.float64(0.7640549759041163))},
        97: {(3, np.float64(0.9249051356359771))},
        99: {(0, np.float64(0.7268830822622097))},
    }
